...
public class LevelManager : MonoBehaviour // Script que controla os níveis do jogo, configurando os valores de dificuldade
                                          // (fácil, médio e difícil) com base nos valores mínimo e máximo definidos no PlayerPrefs.
                                         // Ele também gerencia a transição entre cenas, carregando a cena correspondente ao tópico
                                         // (soma, multiplicação, etc.) e à dificuldade selecionada.
