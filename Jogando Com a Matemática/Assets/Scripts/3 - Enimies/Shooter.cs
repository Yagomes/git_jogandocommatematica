...
public class Shooter : MonoBehaviour, IEnemy // Script para gerenciar o comportamento de um inimigo atirador,
                                             // que dispara rajadas de projéteis em um padrão de cone, com configurações
                                             // para controlar o número de projéteis por rajada, a dispersão do ângulo,
                                             // tempo entre rajadas, e a possibilidade de aplicar um efeito de oscilação.
